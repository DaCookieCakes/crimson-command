...
public sealed partial class HumanoidProfileEditor : BoxContainer
{
        ...
        MarkingManager markings)
    {
        ...
        SubSpeciesEdit.OnTextChanged += args =>
        {
            if (Profile is null)
                return;

            Profile = Profile.WithSubSpecies(args.Text);
            SetDirty();
        };
    ...
    private void UpdateSubSpeciesEdit()
    {
        SubSpeciesEdit.Text = Profile?.SubSpecies ?? "";
    }
}
